...
@section('content')
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('recruiter-account-signin-post')}}">
					...
					<fieldset>
						...
						@if($stored_cookies && !empty($stored_cookies))
							<div class="well col-md-4 col-md-offset-4">
								...
								<div class="media user_account_div" data-id="{{Crypt::encrypt($user_account->id)}}" style="cursor:pointer">
							        ...
							        <div class="media-body">
							          ...
							          <p>{{$user_account->email_address}}</p>
							        </div>
							    </div>   
								@endforeach
							</div>
							<div class="well well-sm col-md-4 col-md-offset-4">
								<div class="col-md-6 text-center" style="border-right:1px solid #ccc">
									<a href="{{route('recruiter-selected-cookie-account')}}">Add account</a>
								</div>
						...
						@else
							...
							<div class="form-group">
								...
								<div class="col-lg-4">
									<input type="text" class="form-control" name="email_address" value="{{ !empty($userDataVerified) ? $userDataVerified->email_address : old('email_address')}}" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-lg-4 col-lg-offset-3">
									<div class="btn-group">
										...
										<a class="btn btn-warning btn-sm" href="{{route('recruiter-account-forgotpassword')}}">Forgot password ?</a>
									</div>
									<!-- <a class="btn btn-primary" href="{{route('account-through', ['provider'=>'facebook'])}}">SignIn with Facebook</a>
									<a class="btn btn-primary" href="{{route('account-through', ['provider'=>'linkedin'])}}">SignIn with LinkedIn</a> -->
								</div>
							</div>
						@endif
						{{csrf_field()}}
...
<form class="form-horizontal hidden" id="submit-cookie-account" method="get" action="{{route('recruiter-selected-cookie-account')}}">
