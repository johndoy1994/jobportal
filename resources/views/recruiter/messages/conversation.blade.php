	...
	<div class="container">
        <div class="row padding-top-10">
            ...
            <div class="col-md-3 text-right padding-top-10">
                <a href="{{route('recruiter-message',array_merge(['search'=>Request::get('search'),'sortBy'=>Request::get('sortBy'),'sortOrder'=>Request::get('sortOrder'),'page'=>Request::get('page')]) )}}" class="btn btn-primary pull-right">Back</a>
            </div>
        </div>
		<hr>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				@include('includes.recruiter.messages.sidebar')
			</div>
            <div class="col-md-9 col-sm-12">
				<div class="chat-panel panel panel-default">
                    ...
                    <div class="panel-body" id="printableArea">
                        <ul class="chat" role="autochat" data-type="2" data-ref="{{$conversation_ref}}">
...
<script type="text/javascript">
	...
	function viewmessageStatusUpdate($conversation_ref){
		...
		$.ajax({
                ...
                data: {'conversation_ref' : $conversation_ref,'type':2,'_token': "{{csrf_token()}}"},
                success: function(data){
                }
            });
	}
