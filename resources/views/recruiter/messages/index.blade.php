			...
			<div class="col-lg-12">
				@if($isRequestSearch)
					<div class="pull-right">
						<a href="{{route('recruiter-message')}}">Reset Search </a>	
					</div>
					<br>
				@endif
	                    ...
	                    <div class="table-responsive">
	                        <table class="table table-striped table-hover">
	                            <thead>
	                                <tr>
	                                    <th>Photo</th>
	                                    <th>Name <!-- <a href="{{route('recruiter-message', $sort_columns['conversation_title']['params'])}}"><i class="glyphicon glyphicon-chevron-{{$sort_columns['conversation_title']['angle']}}"></i></a> --></th>
	                                    <th>Action</th>
	                                </tr>
	                            </thead>
	                            <tbody>
	                            @if(count($myConversations) > 0)
									@foreach($myConversations as $myConversation)
	                                    <tr>
	                                        ...
	                                        <td><a href="{{route('recruiter-conversation', array_merge(['conversation_ref'=>$myConversation->conversation_ref],Request::all()))}}" class="btn btn-primary" role="button">CHAT</a></td>
	                                    </tr>
	                                @endforeach
	                            @else
	                            <tr>
