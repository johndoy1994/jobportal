			...
			<div id="page-wrapper">
				<div class="row padding-top-10">
					...
					<div class="col-md-6 text-right padding-top-10">
						<a href="{{route('api-through', ['provider'=>'google', 'action'=>'contacts', 'redirect'=>'recruiter-gmail-contacts','url'=>$pageUrl])}}" class="btn btn-primary pull-right">Import Gmail contacts</a>
		        ...
		        {{Form::close()}}
		        {{Form::open(array('url' => route('post-recruiter-import-contact'), 'method' => 'post','class'=>'row'))}}	
					<div class="form-row">
					...
					<div class="col-md-12">
						...
						@if($isRequestSearch)
							<a href="{{route('get-recruiter-import-contact',['url'=>Request::get('url')])}}" class="pull-right">Reset Search </a>
						@endif
						<br/><br/>
						<table class="table table-bordered table-striped table-hover">
							<thead>
								<tr>
									...
									<th>Name <a href="{{route('get-recruiter-import-contact', $sort_columns['name']['params'])}}"><i class="fa fa-angle-{{$sort_columns['name']['angle']}}"></i></a></th>
									<th>Email <a href="{{route('get-recruiter-import-contact', $sort_columns['email']['params'])}}"><i class="fa fa-angle-{{$sort_columns['email']['angle']}}"></i></a></th>
								</tr>
							</thead>
							<tbody>
