...
@section('content')
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('admin-renew-job-post', array_merge( ['Job'=> $Jobs->id ], Request::all()) )}}">
					<legend>Renew Job</legend>
