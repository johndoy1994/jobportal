...
@section('content')
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('admin-repost-job-post', array_merge( ['Job'=> $Jobs->id ], Request::all()) )}}">
					<legend>Repost Job</legend>
...
<!-- 											<option value="{{$Jobs->jobAddresses->getStateId()}}" selected>{{$Jobs->jobAddresses->getStateName()}}</option> -->
						...
						<div class="form-group">
							...
							<div class="col-lg-5">
								<input type="text"  required name="starting_date" id="starting_date" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-3">End Date :</label>
							<div class="col-lg-5">
								<input type="text" name="ending_date" id="ending_date" value="{{$Jobs->ending_date ? \Carbon\Carbon::now()->addDay($daysDiff)->format('Y-m-d') : '' }}" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-lg-3">Post Expiration Date *</label>
							<div class="col-lg-5">
								<input type="text"  required name="expiration_date" id="expiration_date" value="{{\Carbon\Carbon::now()->addDay($expirdaysDiff)->format('Y-m-d')}}" class="form-control" />
							</div>
						</div>
						<div class="form-group">
