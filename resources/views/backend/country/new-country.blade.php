...
@section('content')
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('admin-new-country-post')}}">
					...
					<fieldset>
						<div class="form-group">
							...
							<div class="col-lg-9">
								<input type="text" pattern="[A-Za-z0-9-+#(). ]+" title="Please enter valid country name" required name="name" value="{{old('name')}}" class="form-control" />
							</div>
						</div>	
					</fieldset>
					{{csrf_field()}}
