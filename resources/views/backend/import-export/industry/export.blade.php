...
@section('title', 'Export Industry')

@section('content')
	<div id="page-wrapper">
		<div class="row padding-top-10">
			<div class="col-md-9">
				<h3>Export Industry</h3>
			</div>
		...
		<div class="row">
			...
			@endif
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('export-industry-post')}}" enctype="multipart/form-data">
					{{csrf_field()}}
