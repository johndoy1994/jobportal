...
@section('title', 'Import Job Title')

@section('content')
	<div id="page-wrapper">
		<div class="row padding-top-10">
			<div class="col-md-9">
				<h3>Import Job Title</h3>
			</div>
			<div class="col-md-3 text-right padding-top-10">
				...
				<a href="{{route('import-jobtitle-sample')}}" class="btn btn-primary pull-right">Sample CSV</a>
			</div>
		</div>
		<hr/>
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('import-jobtitle-post')}}" enctype="multipart/form-data">
					<legend>Import Job Title</legend>
					...
					<fieldset>
						<div class="form-group">
							...
							<div class="col-lg-5">
								{{Form::select('job_category_id',$JobCategory,old('job_category_id'),['placeholder'=>'Select Job Category Name','class'=>'form-control','required'=>''])}}
							</div>
						</div>
						<div class="form-group">
