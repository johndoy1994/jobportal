...
@section('title', 'Export Job Title')

@section('content')
	<div id="page-wrapper">
		<div class="row padding-top-10">
			<div class="col-md-9">
				<h3>Export Job Title</h3>
			</div>
		...
		<div class="row">
			...
			@endif
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('export-jobtitle-post')}}" enctype="multipart/form-data">
