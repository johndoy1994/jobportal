...
@section('title', 'Export Recruitertype')

@section('content')
	<div id="page-wrapper">
		<div class="row padding-top-10">
			<div class="col-md-9">
				<h3>Export Recruitertype</h3>
			</div>
		...
		<div class="row">
			...
			@endif
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('export-recruitertype-post')}}" enctype="multipart/form-data">
					{{csrf_field()}}
