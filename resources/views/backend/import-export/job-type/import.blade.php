...
@section('title', 'Import Job Type')

@section('content')
	<div id="page-wrapper">
		<div class="row padding-top-10">
			<div class="col-md-9">
				<h3>Import Job Type</h3>
			</div>
			<div class="col-md-3 text-right padding-top-10">
				...
				<a href="{{route('import-job-type-sample')}}" class="btn btn-primary pull-right">Sample CSV</a>
			</div>
		</div>
		<hr/>
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('import-job-type-post')}}" enctype="multipart/form-data">
					<legend>Import Job Type</legend>
