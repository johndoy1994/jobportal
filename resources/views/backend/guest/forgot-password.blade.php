...
@section('content')
	<div class="container">
		<div class="row">
		<a href="{{route('admin-login')}}" class="btn btn-primary pull-right" style="margin-bottom:10px;">Back To Login</a>
		...
		<div class="row">
			<div class="col-md-6">
				<form class="well form-horizontal" method="post" action="{{route('admin-account-forgotpassword-post')}}">
