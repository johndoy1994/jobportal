	...
	<div id="page-wrapper">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<form class="well form-horizontal" method="post" action="{{route('admin-edit-EmployerUser-post',array_merge( ['user'=> $User->id ], Request::all()) )}}">
					...
					<fieldset>
						...
						<div class="col-md-9">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" required name="company_name"  value="{{($employers) ? $employers->company_name : ""}}" class="form-control"  />
								</div>
							</div>	
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									<textarea  class="form-control" title="Enter company description"  name="description" id="description">{{($employers)? $employers->description: ""}}</textarea>
								</div>
							</div>	
							{{csrf_field()}}
