...
@section('content')
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-md-12">
				<form class="well form-horizontal" method="post" action="{{route('admin-edit-education-post', array_merge( ['Education'=> $Educations->id ], Request::all()) )}}">
					...
					<fieldset>
						<div class="form-group">
							...
							<div class="col-lg-9">
								<input type="text" pattern="[A-Za-z0-9/ .]+" title="Please enter valid education name" required name="name" class="form-control" value="{{$Educations->name}}" />
							</div>
						</div>	
