...
class ImportContactController extends FrontendController
{   
    public function getlisting(Request $request){
        ...
        return view('frontend.import-contact.listing', [
    ...
    public function postListing(Request $request)
    {
        ...
        switch($action) {
            ...
            case "Search":
                return redirect()->route('get-jobseeker-import-contact', ['search'=>$request->filter])->withInput(Input::all());
            break;
        }
    }       
    
    public function getIndex() {
    	return view('frontend.import-contact.index');
    }
    ...
    public function getGmailContacts() {
        ...
        $data= PublicRepo::addUserContacts($googleContacts,MyAuth::user(),0);
    	return redirect()->route('get-jobseeker-import-contact',['url'=>$url])->with([
            'success_message' => "Import and merge contact successfully!!"
        ]);

        //return view('frontend.import-contact.gmail', ['googleContacts'=>$googleContacts]);
    }
    ...
    public function postGmailContacts(Request $Request){
        ...
        return redirect()->route('account-home')->withInput(Input::all())->with([
