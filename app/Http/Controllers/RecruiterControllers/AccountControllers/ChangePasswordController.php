...
class ChangePasswordController extends RecruiterController
{
    public function getIndex() {
    	return view('recruiter.account.change-password.index',[
    ...
    public function postSave(Request $request, UserRepo $repo){
    	...
    	list($result, $message) = $repo->updatePassword(MyAuth::user('recruiter')->id, $request->password, $request->password_new);
    	if($result) {
